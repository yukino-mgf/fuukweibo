...
same_uid_file_path = "same_uid_lists.json"
weibo_result_file_path="weibo_result_ar_10_1.txt"
...
# uid_features(weibo_train_sort_path,uid_features_str_file_path)

# same_uid_process(weibo_train_file_path,same_uid_file_path)
# print ("4.User feature extraction has been completed")

# weibo_predict(uid_features_str_file_path,weibo_predict_sort_path,weibo_result_file_path)
# cross_same_predict(same_uid_file_path, weibo_predict_file_path, weibo_result_file_path)
cross_same_predict(same_uid_file_path, weibo_predict_sort_path, weibo_result_file_path)
